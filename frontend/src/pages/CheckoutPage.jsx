...
export default function CheckoutPage() {
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-10">
      <div className="mb-8">
        <h1 className="text-3xl font-black text-[#2C1810]">Checkout</h1>
        <p className="text-gray-500 mt-1">Complete your order securely via Chapa</p>
      </div>
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h2 className="font-black text-[#2C1810]">Pay with Chapa</h2>
            ...
            <div className="mt-4 bg-[#FEF3E2] rounded-xl p-4 flex items-start gap-3">
          ...
          <button
            onClick={handlePay}
            disabled={loading}
            className="w-full bg-[#2C1810] hover:bg-[#1a0e06] text-white py-4 rounded-2xl font-black text-lg transition-all disabled:opacity-60 flex items-center justify-center gap-3"
          >
            {loading
                ...
                {items.map((item, idx) => {
                  ...
                  return (
                    <div key={item?.id || idx} className="flex items-center gap-3">
                      <div className="w-12 h-12 bg-[#F5F0E8] rounded-lg shrink-0 flex items-center justify-center text-[#2C1810] font-bold text-lg">
                        {name[0]}
                      </div>
