        ...
        <div className="lg:col-span-3 space-y-6">
          ...
          <button onClick={handlePay} disabled={loading}
            ...
            {loading
              ...
              : <><span>🇪🇹</span> Pay {safeTotal.toLocaleString()} ETB via Chapa</>
            }
          </button>
            ...
            <div className="p-5">
              ...
              <div className="border-t dark:border-gray-700 pt-4 space-y-2 text-sm">
                <div className="flex justify-between text-gray-600 dark:text-gray-400">
                  <span>Subtotal</span>
                  <span>{safeTotal.toLocaleString()} ETB</span>
                </div>
                <div className="flex justify-between text-gray-600 dark:text-gray-400">
                  <span>Shipping</span>
                ...
                <div className="flex justify-between font-black text-gray-900 dark:text-white text-base pt-2 border-t dark:border-gray-700">
                  <span>Total</span>
                  <span className="text-[#F19A0E]">{safeTotal.toLocaleString()} ETB</span>
                </div>
              </div>
            </div>
          </div>
